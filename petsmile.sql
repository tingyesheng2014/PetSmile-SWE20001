...
(7, 'P3', 'SB1', 'S1', '2023-10-13', '2023-10-15', 'Pending');
...
(1, 'P1', 'SG1', 'S1', '2023-10-08', '11:00', 'Pending'),
(6, 'P1', 'SG2', 'S1', '2023-10-15', '11:30', 'Pending'),
(7, 'P3', 'SB3', 'S1', '2023-10-12', '14:30', 'Pending');
...
--
ALTER TABLE `groomingAppt`
  MODIFY `GAppt_ID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
