    ...
    <div class="container py-5">
        <div class="row py-5">
            <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                ...
                <h5 class="text-muted mb-3">We provide exceptional pet care in a secure, cozy environment, ensuring your peace of mind.</h5>
                <p class="mb-4">Our team is highly skilled and experienced. We are dedicated to providing top-notch services to meet all your pet's needs.
                  Your pet's well-being and happiness are our top priorities. We look forward to serving you and your furry family members.</p>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 py-5 py-lg-0 px-3 px-lg-5">
                    ...
                    <p class="mb-4">We provide personalized, loving care to make sure your pets feel cherished and secure during their stay with us.</p>
                    <div class="row py-2">
                        <div class="col-6">
