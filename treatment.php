...
$selectServicesQuery = "SELECT * FROM service WHERE Service_Type = 'Pet Treatment'";
    ...
    <div class="container-fluid bg-light pt-5 pb-4">
        <div class="container py-5">
            <div class="d-flex flex-column text-center mb-5">
                ...
                <h1 class="display-4 m-0">Pet <span class="text-primary">Treatment</span></h1>
            </div>
            <div class="row">
                <?php
                while ($row = mysqli_fetch_assoc($servicesResult)) {
                    ...
                    echo "<h1 class='display-4 text-white mb-0'><small class='align-top' style='font-size: 22px; line-height: 45px;'>$</small>$price<small class='align-bottom' style='font-size: 16px; line-height: 40px;'></small></h1>";
                    echo '</div>';
                    echo '</div>';
